...
IMAGE_ROOT = Path("/Users/krystalmiao/Downloads/ADNI")  # your full downloaded image folder

OUTPUT_ROOT = PROJECT_ROOT / "data" / "raw_data"
...
print(f"Saved filtered NIfTI files to: {OUTPUT_ROOT}")